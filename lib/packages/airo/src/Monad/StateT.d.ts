...
export declare type StateT<M, S, A> = {
    (s: S): HKT<M, [A, S]>;
};
export declare type StateTF1<M extends HKTSF, S extends AnyFunc, A extends AnyFunc> = {
    (s: S): KindF<M, () => [A, S]>;
};
export declare type StateT1<M extends HKTS, S, A> = {
    (s: S): Kind<M, [A, S]>;
};
export declare type StateT2<M extends HKTS2, S, E, A> = {
    (s: S): Kind2<M, E, [A, S]>;
};
export declare type StateM<M> = {
...
export declare type StateMF1<M extends HKTSF> = {
...
export declare type StateM1<M extends HKTS> = {
...
export declare type StateM2<M extends HKTS2> = {
...
export declare function getStateM<M extends HKTS2>(M: Monad2<M>): StateM2<M>;
export declare function getStateM<M extends HKTSF>(M: MonadF1<M>): StateMF1<M>;
export declare function getStateM<M extends HKTS>(M: Monad1<M>): StateM1<M>;
//# sourceMappingURL=StateT.d.ts.map