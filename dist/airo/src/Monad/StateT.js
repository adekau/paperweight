...
function getStateM(M) {
    return {
        ...
        map: function (ma, f) { return function (s) { return M.map(ma(s), function (_a) {
            var a = _a[0], s1 = _a[1];
            return [f(a), s1];
        }); }; },
        ap: function (mab, ma) { return function (s) { return M.bind(mab(s), function (_a) {
            var f = _a[0], s = _a[1];
            return M.map(ma(s), function (_a) {
                var a = _a[0], s = _a[1];
                return [f(a), s];
            });
        }); }; },
        bind: function (ma, f) { return function (s) { return M.bind(ma(s), function (_a) {
            var a = _a[0], s1 = _a[1];
            return f(a)(s1);
        }); }; },
